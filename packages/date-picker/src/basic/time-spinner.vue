...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'dt-element-ui/src/utils/date-util';
  import ElScrollbar from 'dt-element-ui/packages/scrollbar';
  import RepeatClick from 'dt-element-ui/src/directives/repeat-click';
